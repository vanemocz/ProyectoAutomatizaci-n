...
import "./SaludenCasa.css"

export function SaludenCasa() {
        ...
        <>
            <section class="container-fluid p-1 bg-dark">
                <div class="row">
                    <div class="col-12 text-white fw-bold text-center">
                        <h5 className="text-center" >SALUD EN CASA</h5>
            ...
            <section class="container-fluid my-1">
                <div class="row">
                    ...
                    <div class="col-6 my-3">
                        <h3 className="text-center">Prioridades en el servicio</h3>
                        <h5>Urgente:</h5> <p> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi ut dicta ipsa cum quibusdam consequatur, sed voluptates quasi eum quod voluptatum, expedita numquam rem provident quia rerum impedit assumenda ipsam?</p>
                        <h5>Alta:</h5> <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur maiores magni magnam nobis dolorem eveniet eum inventore. Numquam nisi assumenda id nostrum cumque explicabo aperiam dolorum, quo, totam sed delectus?</p>
                        <h5>Media:</h5> <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, quidem, aliquid, laboriosam illum inventore qui quibusdam illo earum pariatur recusandae voluptate corrupti quis maxime. Repellat, laudantium ipsa! Eaque, sunt culpa!</p>
                        <h5>Baja:</h5> <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo accusamus quisquam architecto sapiente porro fugiat exercitationem, corporis omnis dolorum eligendi aut vel, temporibus, culpa molestias obcaecati sed! Sequi, consequatur similique.</p>
                    </div>
                </div>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <iframe
                            width="640px"
                            height="480px"
                            src="https://forms.office.com/Pages/ResponsePage.aspx?id=_tQLPBERE02ODHwzuet1gaMjBlpNfSRCj8BmFlGL-2NUOTI4MVhBUFFEVkdPN0VPUERBT0k5RUdLRi4u&embed=true"
                            frameBorder={0}
                            marginWidth={0}
                            marginHeight={0}
